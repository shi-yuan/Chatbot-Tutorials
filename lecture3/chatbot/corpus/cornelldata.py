...
class CornellData:
    ...
    def string_filters(self, s):
        """Utility function that remove the nonascii characters
        """
        s = "".join(map(lambda x: x if ord(x) < 128 else ' ', s))
    ...
    def loadConversations(self, fileName, fields):
        ...
        # python 3
        # with open(fileName, 'r', encoding='iso-8859-1') as f:  # TODO: Solve Iso encoding pb !
        with open(fileName) as f:  # TODO: Solve Iso encoding pb !
            for line in f:
                line = self.string_filters(line)
                values = line.split(" +++$+++ ")
